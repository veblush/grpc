...
static const upb_msglayout *const google_api_expr_v1alpha1_Value_submsgs[4] = {
...
static const upb_msglayout_field google_api_expr_v1alpha1_Value__fields[12] = {
  ...
  {9, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 0, 11, _UPB_MODE_SCALAR},
  {10, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 3, 11, _UPB_MODE_SCALAR},
  {11, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 2, 11, _UPB_MODE_SCALAR},
  {12, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 1, 11, _UPB_MODE_SCALAR},
  {15, UPB_SIZE(0, 0), UPB_SIZE(-9, -17), 0, 9, _UPB_MODE_SCALAR},
};
...
static const upb_msglayout *const google_api_expr_v1alpha1_ListValue_submsgs[1] = {
...
static const upb_msglayout *const google_api_expr_v1alpha1_MapValue_submsgs[1] = {
...
static const upb_msglayout *const google_api_expr_v1alpha1_MapValue_Entry_submsgs[1] = {
  &google_api_expr_v1alpha1_Value_msginit,
};
