...
custom_exec_properties(
    ...
    constants = {
        "LARGE_MACHINE": dicts.add(
            create_rbe_exec_properties_dict(),
            # TODO(jtattermusch): specifying 'labels = {"abc": "xyz"}' in create_rbe_exec_properties_dict
            ...
            # manually (see create_rbe_exec_properties_dict logic for how labels get transformed)
